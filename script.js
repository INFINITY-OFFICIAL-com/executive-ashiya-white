...
var translations = {
    ...
    '.overview-body-lead': { ja: '<span class="brand-inline">EXECUTIVE ASHIYA</span> は、株式会社ReFitが運営する、兵庫県芦屋を拠点とした完全会員制のヘルスケアサービスです。トレーナー・管理栄養士・理学療法士がチームとして関わり、運動・栄養・コンディショニングをひとつのプログラムとして設計します。', en: '<span class="brand-inline">EXECUTIVE ASHIYA</span> is a fully members-only healthcare service based in Ashiya, Hyogo, operated by ReFit Inc. Trainers, registered dietitians, and physical therapists work as one team, designing exercise, nutrition, and conditioning as a single program.' },
